---
title: 'Teardown: What Lush Proved by Quitting Social Media'
description: 'In 2021 Lush walked away from Instagram, Facebook, TikTok and Snapchat — and kept selling. What the exit reveals about owned channels, and what local businesses can steal.'
pubDate: 2026-08-24
lang: en
translationKey: lush-teardown
category: case-studies
keywords:
  - Lush social media exit
...
- **An email list and app** that carry launches, restocks and storytelling directly to people who asked for them.
- **A website that behaves like a magazine** — ingredient stories, campaign explainers, product education that search engines can find.
- **Stores built as demonstrations.** Product you're invited to touch, sinks for testing, staff trained to perform the product. The shop is the content studio.

Note the order of operations: own the relationship first, *then* renegotiate with the platforms. A business that quits Instagram with no email list hasn't made a values statement; it has simply vanished. We've written about why [email is the highest-leverage channel most local businesses neglect](/blog/email-marketing-for-local-businesses/) — Lush is what that argument looks like at full scale.
...
We saw the same design logic in our [Aritzia teardown](/blog/aritzia-social-strategy-teardown/): make the product and the space do the performing, and customers become the media. Lush pushed the idea to its logical extreme — the customers kept broadcasting after the brand unplugged its own transmitter.
